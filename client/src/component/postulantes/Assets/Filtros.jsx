import { filterBySeniority, filterByTechnology, filterBySkill, filterByLanguage, 
  getLanguage, getSeniority, getSkill, getTechnology } from "../../../redux/actions/indexP";
...
function Filtros() {
    ...
    const result = useSelector ((state) => state.rootReducerPostulante.filteredVacancy)

    //Filter by SINIORITY
    const allSeniority = useSelector ((state) => state.rootReducerPostulante.seniority)
    ...
    const allTechnology=useSelector((state) => state.rootReducerPostulante.technology)
    ...
    const allLanguages = useSelector ((state) => state.rootReducerPostulante.language)
