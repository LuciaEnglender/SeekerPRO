            ...
            <form onSubmit={(e) => handleSubmit(e)} method="POST">
              <div className="shadow overflow-hidden sm:rounded-md">
                <div className="px-4 py-5 bg-white sm:p-6">
                  ...
                  <h1 className=" font-bold text-zinc-40 text-center mb-3">{empresa[0].name}</h1>
                  <hr />
                  ...
                  <div className="flex flex-col">
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input
                        ...
                        className="mt-1 text-zinc-400 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                      />
                       <div className="px-4 py-3 bg-gray-50 text-right sm:px-6 mt-9">  <button
                    ...
                    <div className="col-span-6 sm:col-span-3 mt-9">
                      ...
                      <select
                        ...
                        className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-zinc-200 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      >
                       <option 
                        className="text-black rounded-2xl bg-verdeClaro"
                        selected
                        disabled
                        ...
                        {technology.map((e) => (
                            <option className="rounded-2xl bg-verdeClaro text-black">{e.name}</option>
                          ))}
                        </select>
                    ...
                    <div className="col-span-6 sm:col-span-3 mt-9">
                      ...
                      >
                        <option  className="text-black rounded-2xl bg-verdeClaro "
                          selected
                          disabled
                          value=""
                        >Select...</option>
                          {language.map((e) => (
                            <option value={e.name} className=' text-black'>{e.name}</option>
                          ))}
                        </select>
                        <div className="flex flex-row">
                    ...
                    <div className="col-span-6 sm:col-span-3 mt-9">
                      ...
                      >
                          <option
                           className="rounded-2xl bg-verdeClaro text-black"
                           selected
                           disabled
                           value="">
                              Select...
                            ...
                            {seniority.map((e) => (
                              <option className="rounded-2xl bg-verdeClaro text-black" value={e.name}>
                                {e.name}
                              </option>
                            ))}
                        </select>
